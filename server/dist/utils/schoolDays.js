...
exports.calculateTotalDays = exports.calculateSchoolDays = void 0;
/**
 ...
 * ```
 */
const calculateSchoolDays = (termStart, termEnd, holidays) => {
    // Input validation
    ...
    for (let currentDate = new Date(termStart); currentDate <= termEnd; currentDate.setDate(currentDate.getDate() + 1)) {
...
exports.calculateSchoolDays = calculateSchoolDays;
/**
